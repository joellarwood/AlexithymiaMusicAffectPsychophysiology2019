...
valencemodel <- afex::mixed(formula = valencekey.keys~affectcat*TAS + (1 + TAS |participant) +(1 + TAS |songmark), data = joined, return = "merMod") 
...
arousalmodel <- afex::mixed(formula = arousalkey.keys~affectcat*TAS + (1 + TAS |participant) +(1 + TAS |songmark), data = joined, return = "merMod") 
