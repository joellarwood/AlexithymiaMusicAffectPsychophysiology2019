...
# Self-report data 
```{r importsurvey}
survey <- read_csv(file = "data/SurveyData_24_10_19.csv")
```
...
# EOT alpha
psych::alpha(select(survey, EOTlist))$total$raw_alpha

# DDF alpha
psych::alpha(select(survey, DDFlist))$total$raw_alpha

#DIF alpha
psych::alpha(select(survey,DIFlist))$total$raw_alpha

# TAS total alpha
psych::alpha(select(survey,EOTlist, DDFlist, DIFlist))$total$raw_alpha 
```
...
psych::alpha(select(survey, depressionlist))$total$raw_alpha
```
