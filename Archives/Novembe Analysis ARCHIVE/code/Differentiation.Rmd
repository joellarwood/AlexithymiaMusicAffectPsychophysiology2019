...
DiffCorVar <- select(joinedICC, ICCneg_r, ICCpos_r, TAS, DDF, DIF, EOT)
DiffCorMatrix <- cor(select(joinedICC, ICCneg_r, ICCpos_r, TAS, DDF, DIF, EOT)) #variables for correlation
